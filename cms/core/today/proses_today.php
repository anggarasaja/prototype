...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "latitude"=>"0",
          "language"=>"en");
          $DATA->updateData($data_form,"today_festival");
          $UTILITY->location_goto("content/today/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="today"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"today_festival");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"today_festival");
     $UTILITY->location_goto("content/today");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"today_festival",1);
  else
        $DATA->publishData($publishdata,"today_festival",0);
     $UTILITY->location_goto("content/today");
}
?>
