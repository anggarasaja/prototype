...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "latitude"=>"0",
          "language"=>"en");
          $DATA->updateData($data_form,"food");
        
          $UTILITY->location_goto("content/food/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="food"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"food");
         $UTILITY->location_goto("content/food/$kategori");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"food");
     $UTILITY->location_goto("content/food/$hapusdatakategori");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"food",1);
  else
        $DATA->publishData($publishdata,"food",0);
 // echo "content/food/$publishkategori";
    $UTILITY->location_goto("content/food/$publishkategori");
}
?>
