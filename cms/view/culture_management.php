...
<html>
     ...
     <head>
          ...
          <?php
          $qWhere = array("id" => $id);
          $data = $DATA->readData($qWhere, "culture");
          //Hitung jmlh data
          if ($data != "")
               $jData = count($data);
          else
          ...
          if ($status_edit == 1) {
               ...
               if ($cek_eksist == 0) {
                    ...
                    $UTILITY->location_goto("content/culture");
               }
          }
          ?>
          <script>
                         ...
                         <div class="col-lg-12">
                              <div class="panel panel-default">
                                   <div class="panel-info">
                                        <ul class="breadcrumb">
                                             <li ><a href="<?= $url_rewrite ?>content/culture">Culture</a></li>
                                   ...
                                   <div class="panel-body">
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <form enctype="multipart/form-data" id="dataForm"name="berita" method="post" action="<?php echo "$url_rewrite"."proses/culture"; ?>">
...
?>
                                            ...
                                            <select class="form-control" id="kategori" name="kategori" >
                                                                                ...
                                                                                <?php
                                                                                $qry = $DB->query("select id_kategori,kategori from kategori_culture");
