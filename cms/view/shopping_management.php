...
<html>
     ...
     <head>
          ...
          <?php
          $qWhere = array("id" => $id);
          $data = $DATA->readData($qWhere, "shopping");
          //Hitung jmlh data
          if ($data != "")
               $jData = count($data);
          else
...
?>
               <div id="page-wrapper">
                    <div class="row">
                         <div class="col-lg-12">
                              <h1 class="page-header">Shoppping</h1>
                         </div>
                         <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                         ...
                         <div class="col-lg-12">
                              <div class="panel panel-default">
                                   <div class="panel-info">
                                        <ul class="breadcrumb">
                                             <li ><a href="<?= $url_rewrite ?>content/shopping">Shoppping</a></li>
                                   ...
                                   <div class="panel-body">
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <form enctype="multipart/form-data" id="dataForm"name="berita" method="post" action="<?php echo "$url_rewrite"."proses/shopping"; ?>">
