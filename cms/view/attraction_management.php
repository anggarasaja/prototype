...
<html>
     ...
     <head>
          ...
          <?php
          $qWhere = array("id" => $id);
          $data = $DATA->readData($qWhere, "attraction");
          //Hitung jmlh data
          if ($data != "")
               $jData = count($data);
          else
          ...
          if ($jData > 0) {
               ...
               $judul = $data->judul;
                 ...
                 $waktu_2= $UTILITY->format_tanggal_time($data->waktu_2);
          ...
          if ($status_edit == 1) {
               ...
               if ($cek_eksist == 0) {
                    ...
                    $UTILITY->location_goto("content/attraction");
               }
          }
          ?>
          <script>
...
?>
               <div id="page-wrapper">
                    <div class="row">
                         <div class="col-lg-12">
                              <h1 class="page-header">Attraction</h1>
                         </div>
                         <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                         ...
                         <div class="col-lg-12">
                              <div class="panel panel-default">
                                   <div class="panel-info">
                                        <ul class="breadcrumb">
                                             <li ><a href="<?= $url_rewrite ?>content/attraction">Attraction</a></li>
                                   ...
                                   <div class="panel-body">
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <form enctype="multipart/form-data" id="dataForm"name="berita" method="post" action="<?php echo "$url_rewrite"."proses/attraction"; ?>">
...
?>
                                            ...
                                            <select class="form-control" id="kategori" name="kategori" >
                                                                                ...
                                                                                <?php
                                                                                $qry = $DB->query("select id_kategori,kategori from kategori_attraction");
...
<?php
if ($id!= "")
     echo("<input class=\"form-control\" id=\"waktu_2\" name=\"waktu_2\" type=\"text\" value=\"$waktu_2\" placeholder=\"Click to open calender\" readonly/>");
else
     echo("<input class=\"form-control\" id=\"waktu_2\" name=\"waktu_2\" type=\"text\" value=\"$waktu_2\" placeholder=\"Click to open calender\" readonly/>");
?>
                                                       </div>
