...
<html>
     ...
     <head>
          ...
          <?php
          $qWhere = array("id" => $id);
          $data = $DATA->readData($qWhere, "about");
          //Hitung jmlh data
          if ($data != "")
               $jData = count($data);
          else
          ...
          if ($status_edit == 1) {
               ...
               if ($cek_eksist == 0) {
                    ...
                    $UTILITY->location_goto("content/about");
               }
          }
          ?>
          <script>
                         ...
                         <div class="col-lg-12">
                              <div class="panel panel-default">
                                   <div class="panel-info">
                                        <ul class="breadcrumb">
                                             <li ><a href="<?= $url_rewrite ?>content/about">About</a></li>
                                   ...
                                   <div class="panel-body">
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <form enctype="multipart/form-data" id="dataForm"name="berita" method="post" action="<?php echo "$url_rewrite"."proses/about"; ?>">
...
<?php
if ($id!= "")
     echo("<input class=\"form-control\" id=\"latitude\" name=\"latitude\" type=\"text\" placeholder=\"Enter Latitude\" value=\"$latitude\" />");
else
     echo("<input class=\"form-control\"  id=\"latitude\" name=\"latitude\" type=\"text\" placeholder=\"Enter Latitude\" value=\"\" />");
?>
                                                       </div>
...
<?php
if ($id!= "")
     echo("<input class=\"form-control\" id=\"longitude\" name=\"longitude\" type=\"text\" placeholder=\"Enter Longitude\" value=\"$longitude\" />");
else
     echo("<input class=\"form-control\"  id=\"longitude\" name=\"longitude\" type=\"text\" placeholder=\"Enter Longitude\" value=\"\" />");
?>
                                                       </div>
                                                       </div>
                                            ...
                                            <select class="form-control" id="kategori" name="kategori" >
                                                                                ...
                                                                                <?php
                                                                                $qry = $DB->query("select id_kategori,kategori from kategori_about");
                                                       ...
                                                       <div class="form-group">
                                            <label>Region</label>
                                            <select class="form-control" id="kategori_2" name="kategori_2" >
                                                                                <option value="0" >None</option>
                                                                                <?php
