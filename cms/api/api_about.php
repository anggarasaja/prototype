	...
	if($rown=$DB->fetch_object($qry_region))
	{
     ...
     //  $row[] ="<img src=\"$url_img/img/$image\" style=\"border: 1px solid #000; max-width:500px; max-height:500px;\" border=\"0\" />";      
       $row[]=$text_publish;
             ...
             $edit="";
            //if($user_id!=$id) {
		$delete="<a href=\"#\" class=\"btn btn-danger\" onClick=\"confirm_delete('$url_rewrite"."proses/about/hdata/$id/$kategori') \"title=\"Hapus\">Hapus</a>";
	//}
            $edit="<a href=\"$url_rewrite"."content/about/edit/$id \" class=\"btn btn-success\" title=\"Edit\">Edit</a>";
             $publish="<a href=\"$url_rewrite"."proses/about/publish/$id/$text_publish/$kategori\" class=\"btn btn-info\" title=\"Publish\">Publish</a>";
